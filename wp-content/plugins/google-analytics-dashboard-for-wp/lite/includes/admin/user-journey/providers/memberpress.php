 ...
 * @since 8.7.0
 */
class ExactMetrics_Lite_User_Journey_MemberPress_Metabox extends ExactMetrics_User_Journey_Lite_Metabox {
...
if ( defined( 'MEPR_VERSION' ) ) {
	new ExactMetrics_Lite_User_Journey_MemberPress_Metabox();
}
